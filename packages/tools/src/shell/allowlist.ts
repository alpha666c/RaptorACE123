...
export const DEFAULT_SHELL_ALLOWLIST: ShellAllowEntry[] = [
  ...
  { cmd: 'pnpm', args: ['outdated'], allowExtraArgs: true, description: 'List outdated deps' },
  ...
  { cmd: 'npm', args: ['audit'], allowExtraArgs: true, description: 'Audit deps for vulnerabilities' },
  ...
  { cmd: 'git', args: ['diff'], allowExtraArgs: true, description: 'Show a git diff' },
  { cmd: 'git', args: ['log'], allowExtraArgs: true, description: 'Show git history' },
  { cmd: 'git', args: ['status'], allowExtraArgs: true, description: 'Show working-tree status' },
  { cmd: 'git', args: ['branch'], allowExtraArgs: true, description: 'List or inspect branches' },
  { cmd: 'git', args: ['rev-parse'], allowExtraArgs: true, description: 'Parse refs' },
];
